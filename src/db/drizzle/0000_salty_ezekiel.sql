...
CREATE TYPE "public"."approval_source" AS ENUM('WEB', 'SMS', 'MANUAL', 'SYSTEM', 'PORTAL', 'SMS_REPLY', 'EMAIL_LINK');--> statement-breakpoint
...
CREATE TYPE "public"."audit_entity_type" AS ENUM('LEAVE_REQUEST', 'LEAVE_EXTENSION', 'LEAVE_APPROVAL', 'QR_PASS', 'MOVEMENT_EVENT', 'POLICY', 'USER', 'STUDENT', 'HOSTEL', 'DEPARTMENT', 'ACADEMIC_GROUP', 'WORKFLOW', 'NOTIFICATION_TEMPLATE', 'NOTIFICATION_RULE', 'LEAVE_TYPE');--> statement-breakpoint
CREATE TYPE "public"."gender" AS ENUM('MALE', 'FEMALE', 'OTHER');--> statement-breakpoint
CREATE TYPE "public"."hostel_gender" AS ENUM('MALE', 'FEMALE', 'MIXED');--> statement-breakpoint
CREATE TYPE "public"."leave_approval_decision" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'AUTO_APPROVED', 'CANCELLED');--> statement-breakpoint
CREATE TYPE "public"."leave_category" AS ENUM('HOME_PASS', 'MEDICAL', 'LOCAL_OUTING', 'NIGHT_OUT', 'ACADEMIC', 'HOSTEL');--> statement-breakpoint
CREATE TYPE "public"."leave_document_status" AS ENUM('ACTIVE', 'REPLACED', 'INVALID', 'DELETED');--> statement-breakpoint
CREATE TYPE "public"."leave_rejection_source" AS ENUM('POLICY', 'VALIDATION');--> statement-breakpoint
CREATE TYPE "public"."leave_status" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'CANCELLED', 'EXPIRED', 'OVERDUE', 'COMPLETED');--> statement-breakpoint
CREATE TYPE "public"."movement_event" AS ENUM('LEAVE_APPROVED', 'EXIT_HOSTEL', 'ENTER_HOSTEL', 'AUTO_OVERDUE', 'MANUAL_RETURN', 'MANUAL_CHECKOUT', 'SECURITY_OVERRIDE', 'QR_INVALIDATED');--> statement-breakpoint
...
CREATE TYPE "public"."notification_channel" AS ENUM('EMAIL', 'SMS', 'PUSH', 'WEBHOOK', 'SLACK');--> statement-breakpoint
CREATE TYPE "public"."notification_delivery_status" AS ENUM('PENDING', 'SENT', 'FAILED', 'DELIVERED', 'READ');--> statement-breakpoint
CREATE TYPE "public"."notification_event" AS ENUM('LEAVE_SUBMITTED', 'LEAVE_APPROVED', 'LEAVE_REJECTED', 'LEAVE_CANCELLED', 'LEAVE_COMPLETED', 'LEAVE_EXPIRED', 'LEAVE_EXTENSION_REQUESTED', 'LEAVE_EXTENSION_APPROVED', 'LEAVE_EXTENSION_REJECTED', 'LEAVE_OVERDUE', 'PARENT_APPROVAL_REQUESTED', 'LEAVE_APPROVAL_REQUIRED', 'LEAVE_POC_REVIEW_REQUIRED', 'QR_GENERATED', 'QR_SCANNED', 'QR_INVALIDATED');--> statement-breakpoint
CREATE TYPE "public"."notification_recipient_type" AS ENUM('STUDENT', 'PARENT', 'CURRENT_APPROVER', 'PREVIOUS_APPROVER', 'ALL_APPROVERS', 'WARDEN', 'POC', 'ADMIN', 'HOSTEL_ADMIN', 'SUPER_ADMIN');--> statement-breakpoint
CREATE TYPE "public"."outbox_status" AS ENUM('PENDING', 'PROCESSING', 'PROCESSED', 'FAILED', 'DEAD_LETTER');--> statement-breakpoint
CREATE TYPE "public"."policy_type" AS ENUM('FORM_VALIDATION', 'ELIGIBILITY', 'LIMIT', 'TIME_WINDOW');--> statement-breakpoint
CREATE TYPE "public"."qr_mode" AS ENUM('NONE', 'EXIT_ONLY', 'RETURN_ONLY', 'BOTH', 'OPTIONAL');--> statement-breakpoint
...
CREATE TABLE "audit_logs" (
	...
	"retention_class" text DEFAULT 'STATE_TRANSITION' NOT NULL,
	"old_data" jsonb,
	"new_data" jsonb,
	"metadata" jsonb,
	"ip_address" text,
...
CREATE TABLE "leave_approvals" (
	...
	"parent_approval_token" text,
	"parent_approval_expires_at" timestamp with time zone,
	"acted_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "leave_approvals_parent_approval_token_unique" UNIQUE("parent_approval_token"),
...
--> statement-breakpoint
CREATE TABLE "leave_configuration_contexts" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"leave_request_id" uuid NOT NULL,
	"leave_type_version_id" uuid NOT NULL,
	"workflow_version_id" uuid NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "leave_configuration_contexts_leave_request_id_unique" UNIQUE("leave_request_id")
);
--> statement-breakpoint
...
CREATE TABLE "qr_passes" (
	...
	CONSTRAINT "qr_pass_leave_request_qr_type_unq" UNIQUE("leave_request_id","qr_type")
);
--> statement-breakpoint
...
ALTER TABLE "leave_configuration_contexts" ADD CONSTRAINT "leave_configuration_contexts_leave_request_id_leave_requests_id_fk" FOREIGN KEY ("leave_request_id") REFERENCES "public"."leave_requests"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "leave_configuration_contexts" ADD CONSTRAINT "leave_configuration_contexts_leave_type_version_id_leave_type_versions_id_fk" FOREIGN KEY ("leave_type_version_id") REFERENCES "public"."leave_type_versions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "leave_configuration_contexts" ADD CONSTRAINT "leave_configuration_contexts_workflow_version_id_workflow_versions_id_fk" FOREIGN KEY ("workflow_version_id") REFERENCES "public"."workflow_versions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "leave_rejections" ADD CONSTRAINT "leave_rejections_student_id_students_id_fk" FOREIGN KEY ("student_id") REFERENCES "public"."students"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "leave_rejections" ADD CONSTRAINT "leave_rejections_leave_type_id_leave_types_id_fk" FOREIGN KEY ("leave_type_id") REFERENCES "public"."leave_types"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "leave_rejections" ADD CONSTRAINT "leave_rejections_leave_request_id_leave_requests_id_fk" FOREIGN KEY ("leave_request_id") REFERENCES "public"."leave_requests"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "leave_type_versions" ADD CONSTRAINT "leave_type_versions_leave_type_id_leave_types_id_fk" FOREIGN KEY ("leave_type_id") REFERENCES "public"."leave_types"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "leave_type_versions" ADD CONSTRAINT "leave_type_versions_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "leave_questions" ADD CONSTRAINT "leave_questions_leave_request_id_leave_requests_id_fk" FOREIGN KEY ("leave_request_id") REFERENCES "public"."leave_requests"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "leave_questions" ADD CONSTRAINT "leave_questions_asked_by_users_id_fk" FOREIGN KEY ("asked_by") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "notification_templates" ADD CONSTRAINT "notification_templates_leave_type_id_leave_types_id_fk" FOREIGN KEY ("leave_type_id") REFERENCES "public"."leave_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "policy_evaluations" ADD CONSTRAINT "policy_evaluations_leave_request_id_leave_requests_id_fk" FOREIGN KEY ("leave_request_id") REFERENCES "public"."leave_requests"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "policy_evaluations" ADD CONSTRAINT "policy_evaluations_policy_id_policies_id_fk" FOREIGN KEY ("policy_id") REFERENCES "public"."policies"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "policy_versions" ADD CONSTRAINT "policy_versions_leave_type_id_leave_types_id_fk" FOREIGN KEY ("leave_type_id") REFERENCES "public"."leave_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "policy_versions" ADD CONSTRAINT "policy_versions_hostel_id_hostels_id_fk" FOREIGN KEY ("hostel_id") REFERENCES "public"."hostels"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "policy_versions" ADD CONSTRAINT "policy_versions_department_id_departments_id_fk" FOREIGN KEY ("department_id") REFERENCES "public"."departments"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "workflow_versions" ADD CONSTRAINT "workflow_versions_workflow_definition_id_workflow_definitions_id_fk" FOREIGN KEY ("workflow_definition_id") REFERENCES "public"."workflow_definitions"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "audit_expires_at_idx" ON "audit_logs" USING btree ("expires_at");--> statement-breakpoint
CREATE UNIQUE INDEX "user_roles_user_role_scope_unq" ON "user_roles" USING btree ("user_id","role_id","scope_type","scope_id");--> statement-breakpoint
...
CREATE INDEX "la_created_at_idx" ON "leave_approvals" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "la_acted_at_idx" ON "leave_approvals" USING btree ("acted_at");--> statement-breakpoint
CREATE INDEX "lcc_leave_type_version_id_idx" ON "leave_configuration_contexts" USING btree ("leave_type_version_id");--> statement-breakpoint
CREATE INDEX "lcc_workflow_version_id_idx" ON "leave_configuration_contexts" USING btree ("workflow_version_id");--> statement-breakpoint
...
CREATE INDEX "leave_rejections_student_id_idx" ON "leave_rejections" USING btree ("student_id");--> statement-breakpoint
CREATE INDEX "leave_rejections_leave_type_id_idx" ON "leave_rejections" USING btree ("leave_type_id");--> statement-breakpoint
CREATE INDEX "leave_rejections_source_idx" ON "leave_rejections" USING btree ("rejection_source");--> statement-breakpoint
CREATE INDEX "leave_rejections_created_at_idx" ON "leave_rejections" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "ltv_leave_type_id_idx" ON "leave_type_versions" USING btree ("leave_type_id");--> statement-breakpoint
CREATE INDEX "ltv_created_at_idx" ON "leave_type_versions" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "qr_scan_logs_scanned_at_idx" ON "qr_scan_logs" USING btree ("scanned_at");--> statement-breakpoint
...
CREATE INDEX "oe_status_next_attempt_idx" ON "outbox_events" USING btree ("status","next_attempt_at");--> statement-breakpoint
CREATE UNIQUE INDEX "outbox_events_idempotency_key_unique_idx" ON "outbox_events" USING btree ("idempotency_key");--> statement-breakpoint
...
CREATE INDEX "pe_leave_request_id_idx" ON "policy_evaluations" USING btree ("leave_request_id");--> statement-breakpoint
CREATE INDEX "pe_policy_version_id_idx" ON "policy_evaluations" USING btree ("policy_version_id");--> statement-breakpoint
CREATE INDEX "pov_policy_id_idx" ON "policy_versions" USING btree ("policy_id");--> statement-breakpoint
CREATE INDEX "pov_leave_type_id_idx" ON "policy_versions" USING btree ("leave_type_id");--> statement-breakpoint
CREATE INDEX "pov_hostel_id_idx" ON "policy_versions" USING btree ("hostel_id");--> statement-breakpoint
...
CREATE INDEX "workflow_steps_role_idx" ON "workflow_steps" USING btree ("approver_role_id");--> statement-breakpoint
CREATE INDEX "wv_workflow_definition_id_idx" ON "workflow_versions" USING btree ("workflow_definition_id");--> statement-breakpoint
CREATE INDEX "wv_created_at_idx" ON "workflow_versions" USING btree ("created_at");