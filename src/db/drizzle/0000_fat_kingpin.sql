...
CREATE TYPE "public"."notification_event" AS ENUM('LEAVE_SUBMITTED', 'LEAVE_APPROVED', 'LEAVE_REJECTED', 'LEAVE_CANCELLED', 'LEAVE_COMPLETED', 'LEAVE_EXPIRED', 'LEAVE_EXTENSION_REQUESTED', 'LEAVE_EXTENSION_APPROVED', 'LEAVE_EXTENSION_REJECTED', 'LEAVE_OVERDUE', 'PARENT_APPROVAL_REQUESTED', 'QR_GENERATED', 'QR_SCANNED', 'QR_INVALIDATED');--> statement-breakpoint
...
CREATE TYPE "public"."policy_type" AS ENUM('FORM_VALIDATION', 'ELIGIBILITY', 'LIMIT', 'WORKFLOW', 'DOCUMENT_REQUIREMENT', 'QR_RULE', 'TIME_WINDOW', 'FEATURE_FLAG');--> statement-breakpoint
...
CREATE TABLE "leave_approvals" (
	...
	"parent_approval_otp_hash" text,
	"parent_approval_expires_at" timestamp with time zone,
	"parent_approval_verified_at" timestamp with time zone,
	"metadata" jsonb,
...
CREATE INDEX "pos_phone_idx" ON "parent_otp_sessions" USING btree ("phone");--> statement-breakpoint
