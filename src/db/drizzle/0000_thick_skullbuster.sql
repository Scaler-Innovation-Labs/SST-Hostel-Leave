...
CREATE TYPE "public"."notification_event" AS ENUM('LEAVE_SUBMITTED', 'LEAVE_APPROVED', 'LEAVE_REJECTED', 'LEAVE_CANCELLED', 'LEAVE_COMPLETED', 'LEAVE_EXPIRED', 'LEAVE_EXTENSION_REQUESTED', 'LEAVE_EXTENSION_APPROVED', 'LEAVE_EXTENSION_REJECTED', 'LEAVE_OVERDUE', 'PARENT_APPROVAL_REQUESTED', 'QR_GENERATED', 'QR_INVALIDATED');--> statement-breakpoint
...
CREATE TYPE "public"."policy_type" AS ENUM('MAX_DAYS', 'BLOCK_DURING_PERIOD', 'RESTRICT_BATCH', 'REQUIRE_PARENT_APPROVAL', 'CURFEW_RESTRICTION', 'MAX_EXTENSION_COUNT', 'FORM_FIELD_RESTRICTION');--> statement-breakpoint
