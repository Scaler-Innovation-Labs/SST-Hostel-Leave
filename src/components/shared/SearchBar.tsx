...
export function SearchBar({
  ...
  return (
    <input
      ...
      className={cn(
        "h-8 w-full rounded-lg border border-input bg-background px-3 text-body placeholder:text-muted focus:border-ring focus:outline-none focus:ring-1 focus:ring-ring",
        className,
      )}
    />
  );
